          ...
          {isAuthenticated && user ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 px-4 py-2 rounded-xl glass-effect border border-border/30 hover:border-primary/40 transition-all">
            ...
            <button
              ...
              className="px-4 py-2 rounded-xl bg-primary text-white font-semibold hover:bg-primary/90 transition-all duration-300 hover:scale-105"
            >
              Login
            </button>
          )}
